        ...
        var anchor:Vec2;
            ...
            cbtype(body.cbTypes,"");
                ...
                prop = fprop("default");
                        ...
                        s = new Polygon(
                            [   Vec2.weak(-0.5,159)   ,  Vec2.weak(0,511.5)   ,  Vec2.weak(2045,517)   ,  Vec2.weak(511,158.5)   ],
                            mat,
                            filt
                        );
                        s.body = body;
                        ...
                        s = new Polygon(
                            [   Vec2.weak(2045,105.5)   ,  Vec2.weak(2004,105.5)   ,  Vec2.weak(1967,108.5)   ,  Vec2.weak(1925,118.5)   ,  Vec2.weak(1885,131.5)   ,  Vec2.weak(1857,142.5)   ,  Vec2.weak(1817,161.5)   ,  Vec2.weak(2045,517)   ],
                            mat,
                            filt
                        );
                        s.body = body;
                        ...
                        s = new Polygon(
                            [   Vec2.weak(1033,145.5)   ,  Vec2.weak(998,130.5)   ,  Vec2.weak(963,119.5)   ,  Vec2.weak(920,110.5)   ,  Vec2.weak(1069,170)   ],
                            mat,
                            filt
                        );
                        s.body = body;
                        ...
                        s = new Polygon(
                            [   Vec2.weak(1817,161.5)   ,  Vec2.weak(1751,201.5)   ,  Vec2.weak(2045,517)   ],
                            mat,
                            filt
                        );
                        s.body = body;
                        ...
                        s = new Polygon(
                            [   Vec2.weak(1751,201.5)   ,  Vec2.weak(1722,213.5)   ,  Vec2.weak(2045,517)   ],
                            mat,
                            filt
                        );
                        s.body = body;
                        ...
                        s = new Polygon(
                            [   Vec2.weak(1069,170)   ,  Vec2.weak(920,110.5)   ,  Vec2.weak(868,102.5)   ,  Vec2.weak(832,101.5)   ,  Vec2.weak(590,144.5)   ,  Vec2.weak(1162,240)   ,  Vec2.weak(1131,211.5)   ],
                            mat,
                            filt
                        );
                        s.body = body;
                        ...
                        s = new Polygon(
                            [   Vec2.weak(1722,213.5)   ,  Vec2.weak(1696,214.5)   ,  Vec2.weak(2045,517)   ],
                            mat,
                            filt
                        );
                        s.body = body;
                        ...
                        s = new Polygon(
                            [   Vec2.weak(1614,203.5)   ,  Vec2.weak(1410,214.5)   ,  Vec2.weak(1391,217.5)   ,  Vec2.weak(2045,517)   ,  Vec2.weak(1674,212.5)   ],
                            mat,
                            filt
                        );
                        s.body = body;
                        ...
                        s = new Polygon(
                            [   Vec2.weak(1246,232.5)   ,  Vec2.weak(1224,240.5)   ,  Vec2.weak(2045,517)   ,  Vec2.weak(1391,217.5)   ],
                            mat,
                            filt
                        );
                        s.body = body;
                        ...
                        s = new Polygon(
                            [   Vec2.weak(800,103.5)   ,  Vec2.weak(750,110.5)   ,  Vec2.weak(590,144.5)   ,  Vec2.weak(832,101.5)   ],
                            mat,
                            filt
                        );
                        s.body = body;
                        ...
                        s = new Polygon(
                            [   Vec2.weak(1696,214.5)   ,  Vec2.weak(1674,212.5)   ,  Vec2.weak(2045,517)   ],
                            mat,
                            filt
                        );
                        s.body = body;
                        ...
                        s = new Polygon(
                            [   Vec2.weak(511,158.5)   ,  Vec2.weak(2045,517)   ,  Vec2.weak(1162,240)   ,  Vec2.weak(590,144.5)   ],
                            mat,
                            filt
                        );
                        s.body = body;
                        ...
                        s = new Polygon(
                            [   Vec2.weak(1224,240.5)   ,  Vec2.weak(1203,243.5)   ,  Vec2.weak(2045,517)   ],
                            mat,
                            filt
                        );
                        s.body = body;
                        ...
                        s = new Polygon(
                            [   Vec2.weak(1203,243.5)   ,  Vec2.weak(1162,240)   ,  Vec2.weak(2045,517)   ],
                            mat,
                            filt
                        );
                        s.body = body;
            ...
            cbtype(body.cbTypes,"");
                ...
                prop = fprop("default");
                        ...
                        s = new Polygon(
                            [   Vec2.weak(2047.5,511)   ,  Vec2.weak(2047,144.5)   ,  Vec2.weak(2025,139.5)   ,  Vec2.weak(1828,153.5)   ,  Vec2.weak(0,511.5)   ],
                            mat,
                            filt
                        );
                        s.body = body;
                        ...
                        s = new Polygon(
                            [   Vec2.weak(1110,110.5)   ,  Vec2.weak(1061,136.5)   ,  Vec2.weak(1178,102.5)   ,  Vec2.weak(1132,106.5)   ],
                            mat,
                            filt
                        );
                        s.body = body;
                        ...
                        s = new Polygon(
                            [   Vec2.weak(1368,105.5)   ,  Vec2.weak(1343,100.5)   ,  Vec2.weak(1307,96.5)   ,  Vec2.weak(1243,95.5)   ,  Vec2.weak(1423,131.5)   ],
                            mat,
                            filt
                        );
                        s.body = body;
                        ...
                        s = new Polygon(
                            [   Vec2.weak(598,193.5)   ,  Vec2.weak(554,187.5)   ,  Vec2.weak(526,187.5)   ,  Vec2.weak(506,189.5)   ,  Vec2.weak(444,201.5)   ,  Vec2.weak(0,511.5)   ,  Vec2.weak(647,207.5)   ],
                            mat,
                            filt
                        );
                        s.body = body;
                        ...
                        s = new Polygon(
                            [   Vec2.weak(320,198.5)   ,  Vec2.weak(0,511.5)   ,  Vec2.weak(349,210)   ],
                            mat,
                            filt
                        );
                        s.body = body;
                        ...
                        s = new Polygon(
                            [   Vec2.weak(1882,136.5)   ,  Vec2.weak(1857,143.5)   ,  Vec2.weak(1828,153.5)   ,  Vec2.weak(2025,139.5)   ,  Vec2.weak(1985,133.5)   ,  Vec2.weak(1957,131.5)   ,  Vec2.weak(1923,131.5)   ],
                            mat,
                            filt
                        );
                        s.body = body;
                        ...
                        s = new Polygon(
                            [   Vec2.weak(349,210)   ,  Vec2.weak(0,511.5)   ,  Vec2.weak(373,210.5)   ],
                            mat,
                            filt
                        );
                        s.body = body;
                        ...
                        s = new Polygon(
                            [   Vec2.weak(404,207.5)   ,  Vec2.weak(0,511.5)   ,  Vec2.weak(444,201.5)   ],
                            mat,
                            filt
                        );
                        s.body = body;
                        ...
                        s = new Polygon(
                            [   Vec2.weak(647,207.5)   ,  Vec2.weak(0,511.5)   ,  Vec2.weak(678,213.5)   ],
                            mat,
                            filt
                        );
                        s.body = body;
                        ...
                        s = new Polygon(
                            [   Vec2.weak(1828,153.5)   ,  Vec2.weak(1677,153.5)   ,  Vec2.weak(1535,159.5)   ,  Vec2.weak(867,239.5)   ,  Vec2.weak(0,511.5)   ],
                            mat,
                            filt
                        );
                        s.body = body;
                        ...
                        s = new Polygon(
                            [   Vec2.weak(867,239.5)   ,  Vec2.weak(1535,159.5)   ,  Vec2.weak(1518,159.5)   ,  Vec2.weak(898,229.5)   ],
                            mat,
                            filt
                        );
                        s.body = body;
                        ...
                        s = new Polygon(
                            [   Vec2.weak(1518,159.5)   ,  Vec2.weak(1478,151.5)   ,  Vec2.weak(898,229.5)   ],
                            mat,
                            filt
                        );
                        s.body = body;
