package local.map.scene
{
	 ...
	 * @author zhouzhanglin
	 */	
	public class BuildingScene extends SIsoScene
	{
...
//			var roads:Array =[];
//			var road:Road ;
//			for each( var obj:SIsoObject in GameWorld.instance.roadScene.children)
//			{
...
//			moveItems = [] ;
		...
		/**        排序算法           */
		override protected function sortCompare( target:SIsoObject , item:SIsoObject ):int
		{
