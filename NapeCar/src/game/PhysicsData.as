package  game{
	...
	public class PhysicsData {
		...
		private static function init():void {
			...
			s = new Polygon(
				[   Vec2.weak(0,511.5)   ,  Vec2.weak(1023.5,511)   ,  Vec2.weak(804,355.5)   ,  Vec2.weak(792,351.5)   ,  Vec2.weak(39,250.5)   ,  Vec2.weak(-0.5,251)   ],
				mat,
				filt
			);
			s.body = body;
			...
			s = new Polygon(
				[   Vec2.weak(985,250.5)   ,  Vec2.weak(977,254.5)   ,  Vec2.weak(961.5,268)   ,  Vec2.weak(916,313.5)   ,  Vec2.weak(1023.5,511)   ,  Vec2.weak(1023,249.5)   ,  Vec2.weak(992,249.5)   ],
				mat,
				filt
			);
			s.body = body;
			...
			s = new Polygon(
				[   Vec2.weak(916,313.5)   ,  Vec2.weak(892,331.5)   ,  Vec2.weak(1023.5,511)   ],
				mat,
				filt
			);
			s.body = body;
			...
			s = new Polygon(
				[   Vec2.weak(892,331.5)   ,  Vec2.weak(872,342.5)   ,  Vec2.weak(1023.5,511)   ],
				mat,
				filt
			);
			s.body = body;
			...
			s = new Polygon(
				[   Vec2.weak(872,342.5)   ,  Vec2.weak(839,353.5)   ,  Vec2.weak(1023.5,511)   ],
				mat,
				filt
			);
			s.body = body;
			...
			s = new Polygon(
				[   Vec2.weak(839,353.5)   ,  Vec2.weak(813,356.5)   ,  Vec2.weak(1023.5,511)   ],
				mat,
				filt
			);
			s.body = body;
			...
			s = new Polygon(
				[   Vec2.weak(678,275.5)   ,  Vec2.weak(656,271.5)   ,  Vec2.weak(608,271.5)   ,  Vec2.weak(779.5,344)   ,  Vec2.weak(737,305.5)   ,  Vec2.weak(717,291.5)   ,  Vec2.weak(704,284.5)   ],
				mat,
				filt
			);
			s.body = body;
			...
			s = new Polygon(
				[   Vec2.weak(423,139.5)   ,  Vec2.weak(404,129.5)   ,  Vec2.weak(371,119.5)   ,  Vec2.weak(324,118.5)   ,  Vec2.weak(521.5,232)   ,  Vec2.weak(446,156.5)   ],
				mat,
				filt
			);
			s.body = body;
			...
			s = new Polygon(
				[   Vec2.weak(388,123.5)   ,  Vec2.weak(371,119.5)   ,  Vec2.weak(404,129.5)   ],
				mat,
				filt
			);
			s.body = body;
			...
			s = new Polygon(
				[   Vec2.weak(289,125.5)   ,  Vec2.weak(264,133.5)   ,  Vec2.weak(202,159.5)   ,  Vec2.weak(110,207.5)   ,  Vec2.weak(39,250.5)   ,  Vec2.weak(552,254.5)   ,  Vec2.weak(324,118.5)   ,  Vec2.weak(323,118.5)   ],
				mat,
				filt
			);
			s.body = body;
			...
			s = new Polygon(
				[   Vec2.weak(608,271.5)   ,  Vec2.weak(592,269.5)   ,  Vec2.weak(792,351.5)   ,  Vec2.weak(779.5,344)   ],
				mat,
				filt
			);
			s.body = body;
			...
			s = new Polygon(
				[   Vec2.weak(813,356.5)   ,  Vec2.weak(804,355.5)   ,  Vec2.weak(1023.5,511)   ],
				mat,
				filt
			);
			s.body = body;
			...
			s = new Polygon(
				[   Vec2.weak(521.5,232)   ,  Vec2.weak(324,118.5)   ,  Vec2.weak(552,254.5)   ],
				mat,
				filt
			);
			s.body = body;
			...
			s = new Polygon(
				[   Vec2.weak(592,269.5)   ,  Vec2.weak(576,265.5)   ,  Vec2.weak(39,250.5)   ,  Vec2.weak(792,351.5)   ],
				mat,
				filt
			);
			s.body = body;
			...
			s = new Polygon(
				[   Vec2.weak(576,265.5)   ,  Vec2.weak(552,254.5)   ,  Vec2.weak(39,250.5)   ],
				mat,
				filt
			);
			s.body = body;
